...
export default function GlobalHeader() {
  ...
  return (
    <header className="h-14 w-full fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-lg border-b-2 border-green-500/50 shadow-lg shadow-green-500/20">
